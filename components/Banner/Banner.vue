...
<template>
  <span
    class="flex items-center w-full h-[110px] p-2 justify-between md:justify-normal lg:max-w-[1350px] m-auto mt-2 bg-[#d9d9d9]"
  >
    <div>
      <img :src="notiarve" alt="Noti AR" width="120" />
    </div>
